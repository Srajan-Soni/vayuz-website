...
const SideBar = () => {
    const [lists, setlists] = useState([{ name:"App Development" , link:"#app-development"},
  ...
  <button className="relative cursor-pointer group inline-block p-[2px] rounded-full bg-gradient-to-r from-green-400 via-pink-500 to-yellow-500 transition-all duration-300 hover:scale-105 hover:shadow-lg hover:shadow-pink-300/30">
    <a href="#contactUs" className="block rounded-full bg-black text-white px-8 py-2 text-lg font-medium transition-all duration-300 group-hover:bg-gradient-to-r group-hover:from-green-500 group-hover:to-yellow-500 group-hover:text-black">
      CONTACT US
    </a>
  </button>
</div>
